...
declare type ExpressionName = 'array' | 'boolean' | 'collator' | 'format' | 'image' | 'literal' | 'number' | 'number-format' | 'object' | 'string' | 'to-boolean' | 'to-color' | 'to-number' | 'to-string' | 'typeof' | 'accumulated' | 'feature-state' | 'geometry-type' | 'id' | 'line-progress' | 'properties' | 'at' | 'get' | 'has' | 'in' | 'index-of' | 'length' | 'slice' | '!' | '!=' | '<' | '<=' | '==' | '>' | '>=' | 'all' | 'any' | 'case' | 'match' | 'coalesce' | 'within' | 'interpolate' | 'interpolate-hcl' | 'interpolate-lab' | 'step' | 'let' | 'var' | 'concat' | 'downcase' | 'is-supported-script' | 'resolved-locale' | 'upcase' | 'rgb' | 'rgba' | 'to-rgba' | '-' | '*' | '/' | '%' | '^' | '+' | 'abs' | 'acos' | 'asin' | 'atan' | 'ceil' | 'cos' | 'distance' | 'e' | 'floor' | 'ln' | 'ln2' | 'log10' | 'log2' | 'max' | 'min' | 'pi' | 'round' | 'sin' | 'sqrt' | 'tan' | 'zoom' | 'heatmap-density';
declare type ExpressionField = string | number | boolean | Expression | ExpressionField[] | {
    [key: string]: ExpressionField;
};
export declare type Expression = [ExpressionName, ...ExpressionField[]];
declare type ExpressionParameters = 'zoom' | 'feature' | 'feature-state' | 'sky-radial-progress' | 'line-progress' | 'heatmap-density';
declare type ResolvedImageType = ImageSourcePropType;
export declare type Value<T, AllowedParameters extends ExpressionParameters[] = []> = T | Expression;
...
declare type VisibilityEnumValues = 'visible' | 'none';
...
declare type LineCapEnumValues = 'butt' | 'round' | 'square';
...
declare type LineJoinEnumValues = 'bevel' | 'round' | 'miter';
...
declare type SymbolPlacementEnumValues = 'point' | 'line' | 'line-center';
...
declare type SymbolZOrderEnumValues = 'auto' | 'viewport-y' | 'source';
...
declare type IconRotationAlignmentEnumValues = 'map' | 'viewport' | 'auto';
...
declare type IconTextFitEnumValues = 'none' | 'width' | 'height' | 'both';
...
declare type IconAnchorEnumValues = 'center' | 'left' | 'right' | 'top' | 'bottom' | 'top-left' | 'top-right' | 'bottom-left' | 'bottom-right';
...
declare type IconPitchAlignmentEnumValues = 'map' | 'viewport' | 'auto';
...
declare type TextPitchAlignmentEnumValues = 'map' | 'viewport' | 'auto';
...
declare type TextRotationAlignmentEnumValues = 'map' | 'viewport' | 'auto';
...
declare type TextJustifyEnumValues = 'auto' | 'left' | 'center' | 'right';
...
declare type TextVariableAnchorEnumValues = 'center' | 'left' | 'right' | 'top' | 'bottom' | 'top-left' | 'top-right' | 'bottom-left' | 'bottom-right';
...
declare type TextAnchorEnumValues = 'center' | 'left' | 'right' | 'top' | 'bottom' | 'top-left' | 'top-right' | 'bottom-left' | 'bottom-right';
...
declare type TextWritingModeEnumValues = 'horizontal' | 'vertical';
...
declare type TextTransformEnumValues = 'none' | 'uppercase' | 'lowercase';
...
declare type CirclePitchScaleEnumValues = 'map' | 'viewport';
...
declare type CirclePitchAlignmentEnumValues = 'map' | 'viewport';
...
declare type RasterResamplingEnumValues = 'linear' | 'nearest';
...
declare type HillshadeIlluminationAnchorEnumValues = 'map' | 'viewport';
...
declare type SkyTypeEnumValues = 'gradient' | 'atmosphere';
...
declare type AnchorEnumValues = 'map' | 'viewport';
declare type Enum<EnumType, EnumValues> = EnumType | EnumValues;
...
export declare type AllLayerStyleProps = FillLayerStyleProps | LineLayerStyleProps | SymbolLayerStyleProps | CircleLayerStyleProps | HeatmapLayerStyleProps | FillExtrusionLayerStyleProps | RasterLayerStyleProps | HillshadeLayerStyleProps | BackgroundLayerStyleProps | SkyLayerStyleProps | LightLayerStyleProps | AtmosphereLayerStyleProps | TerrainLayerStyleProps;
export {};
