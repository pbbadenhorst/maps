...
class AbstractLayer extends React.PureComponent {
    constructor() {
        super(...arguments);
        this.nativeLayer = undefined;
        this.setNativeLayer = (instance) => {
            this.nativeLayer = instance;
        };
    }
    get baseProps() {
        return Object.assign(Object.assign({}, this.props), { id: this.props.id, sourceID: this.props.sourceID, reactStyle: this.getStyle(this.props.style), minZoomLevel: this.props.minZoomLevel, maxZoomLevel: this.props.maxZoomLevel, aboveLayerID: this.props.aboveLayerID, belowLayerID: this.props.belowLayerID, layerIndex: this.props.layerIndex, filter: getFilter(this.props.filter), style: undefined });
    }
    ...
    setNativeProps(props) {
        ...
        if (this.nativeLayer) {
            ...
            (_a = this.nativeLayer) === null || _a === void 0 ? void 0 : _a.setNativeProps(propsToPass);
        }
    }
}
